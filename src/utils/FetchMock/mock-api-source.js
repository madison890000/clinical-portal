    ...
    fetchMockInstance
        ...
        .get(
            ...
            function (_path, opts) {
                ...
                return new Response(
                    JSON.stringify(loggedInUser === JOSH_SMITH_USERNAME ? JOSH_SMITH_DETAILS : AMY_BARKER_DETAILS),
                    {
                        status: 200
                    }
                );
        ...
        .get(
            ...
            function (path, opts) {
                ...
                if (
                    (loggedInUser === JOSH_SMITH_USERNAME &&
                        !JOSH_SMITH_PATIENTS.flatMap(function (patient) {
                            return patient.id;
                        }).includes(patientId)) ||
                    (loggedInUser === AMY_BARKER_USERNAME &&
                        !AMY_BARKER_PATIENTS.flatMap(function (patient) {
                            return patient.id;
                        }).includes(patientId))
                ) {
                ...
                return new Response(
                    JSON.stringify(
                        loggedInUser === JOSH_SMITH_USERNAME
                            ? JOSH_SMITH_PATIENT_DETAILS_BY_ID[patientId]
                            : AMY_BARKER_PATIENT_DETAILS_BY_ID[patientId]
                    ),
                    {
                        status: 200
                    }
